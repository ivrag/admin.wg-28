...
if (!empty($_SESSION["wg28-user"]) && $_SESSION["auth"] === True) {
  $page = "ivr/websites/projects/wohnung_28";
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body" id="main-card-body">
                  ...
                  <div class="float-right">
                    <a href="https://ivrag.ch/projects/wohnung28" id="prev-btn" class="btn btn-info" target="_blank" rel="noopener noreferrer"><i class="far fa-eye"></i> Vorschau</a>
