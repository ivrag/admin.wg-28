        ...
        <div class="container-fluid" id="main-content">
          ...
          <div class="row">
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header d-sm-flex align-items-center justify-content-between py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Über Uns</h6>
                </div>
                <div class="card-body" id="main-card-body">
                  ...
                  <div class="float-right">
                    <a href="https://ivrag.ch/about" id="prev-btn" class="btn btn-info" target="_blank" rel="noopener noreferrer"><i class="far fa-eye"></i> Vorschau</a>
