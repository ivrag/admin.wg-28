...
<head>
  ...
  <title>404 &bull; ivrag-admin</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid mt-5">
          ...
          <div class="text-center">
            ...
            <p class="lead text-gray-800 mb-5">Seite nicht gefunden !</p>
            <p class="text-gray-500 mb-0">Ooops... Da ist etwas ziemlich schief geloffen...</p>
            <a href="../dashboard/">&larr; Zurück zum Dashboard</a>
          </div>
      ...
      <footer class="sticky-footer bg-white">
        <?php require_once "../assets/client/footer.php" ?>
      </footer>
      <!-- End of Footer -->
